...
function GoldRadio({ checked, name, onChange, label }: { checked: boolean; name: string; onChange: () => void; label: string }) {
  return (
...
/** Dark premium filter panel — grades 1–9, semester, material type, access. */
export function SubjectsPremiumFilterSidebar({
  classes,
  classLevel,
  semester,
  accessFilter,
