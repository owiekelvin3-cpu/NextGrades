                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex shrink-0 items-center gap-2">
                          {lesson.zoom_link && tab === "upcoming" ? (
                            <a
                              href={lesson.zoom_link}
                              target="_blank"
                              rel="noopener noreferrer"
                              className="inline-flex items-center gap-2 rounded-xl bg-[#2D8CFF] px-4 py-2.5 text-sm font-semibold text-white hover:bg-[#1a7ae8]"
                            >
            ...
            <div className={studentPanel("p-5")}>
              ...
              {data.nextLesson.zoom_link && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="mt-4 flex w-full items-center justify-center gap-2 rounded-xl bg-[#2D8CFF] py-2.5 text-sm font-semibold text-white hover:bg-[#1a7ae8]"
                >
                  <Video className="h-4 w-4" />
                  {t("studentDashboard.joinZoomMeeting", { defaultValue: "Join Zoom meeting" })}
                </a>
