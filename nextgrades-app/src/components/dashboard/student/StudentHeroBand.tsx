  ...
  return (
    <section className={cn("student-hero", compact ? "p-5" : "p-6 sm:p-8")}>
      <div className="relative grid gap-6 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-start">
        <div className="min-w-0">
          ...
          >
            ...
            <Link
              ...
              className="text-xs font-semibold text-[var(--brand-gold-light)] hover:underline sm:ml-auto"
            >
        ...
        <div className="flex min-w-0 flex-col gap-3 sm:flex-row lg:w-52 lg:flex-col">
          {!compact && typeof overallProgress === "number" && (
            <div className="flex items-center gap-4 rounded-xl border border-white/12 bg-white/8 px-4 py-3 backdrop-blur-sm sm:flex-1 lg:flex-none">
              <div
          ...
          <div className="flex min-w-0 flex-col gap-2.5 sm:flex-1 lg:flex-none">
            <Button
              variant="gold"
              size={compact ? "sm" : "md"}
            ...
            {!compact && (
              <Button
                ...
                size="md"
                href="/dashboard/chat"
                className="w-full justify-center border-[var(--brand-gold)]/40 text-[var(--brand-gold-light)] hover:bg-[var(--brand-gold)]/10"
              >
