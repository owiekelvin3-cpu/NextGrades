                  ...
                  <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
                    ...
                    {lesson.zoom_link && (
                      <a
                        ...
                        className="inline-flex shrink-0 items-center justify-center gap-2 rounded-xl bg-[#2D8CFF] px-6 py-3 text-sm font-bold text-white shadow-sm transition hover:bg-[#1a7ae8]"
                      >
                        <Video className="h-5 w-5" />
                        {t("studentDashboard.joinClass", { defaultValue: "Join class" })}
                      </a>
                    )}
                  </div>
                </div>
