...
export function FloatingChatButton({ onClick, unread }: { onClick: () => void; unread?: boolean }) {
  return (
    <motion.button
      ...
      whileTap={{ scale: 0.95 }}
      className="fixed bottom-6 right-6 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-[#D4AF37] to-[#F5A623] text-[#0D1B2A] shadow-lg shadow-[#D4AF37]/30"
