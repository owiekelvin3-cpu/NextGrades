...
import { Search, Bell, X, Settings, LayoutDashboard } from "lucide-react";
    ...
    <AnimatePresence>
      {open && (
        <>
          ...
          >
            <div className="flex h-16 items-center justify-between border-b border-border-default/60 px-5">
