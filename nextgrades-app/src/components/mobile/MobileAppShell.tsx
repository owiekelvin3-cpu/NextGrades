...
export function MobileAppShell({
  ...
  return (
    <div className={cn(appShell.dashboardShell, "md:bg-surface-dashboard")}>
      <Sidebar
        role={role}
      ...
      <div
        className={cn(
          "flex min-w-0 flex-1 flex-col bg-surface-dashboard md:bg-transparent",
      ...
      >
        ...
        <header
          className={cn(
            ...
            "hidden md:block md:sticky md:top-0 md:z-30",
            mobile.pageX,
            "py-4 lg:py-5"
          )}
        >
        ...
        <main className={cn("flex-1 overflow-x-hidden", mobile.pageX, "pb-6 pt-2 md:py-6 lg:py-8")}>
