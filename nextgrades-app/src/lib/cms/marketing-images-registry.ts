...
export const CMS_IMAGE_REGISTRY: CmsImageRegistryItem[] = [
  ...
  { key: "cmsImages.resources.hero", label: "Lernbibliothek — Hero image", pageGroup: "resources", defaultUrl: RESOURCES_HERO_IMAGE },
  { key: "cmsImages.pricing.hero", label: "Pricing — Hero image", pageGroup: "pricing", defaultUrl: PRICING_HERO_IMAGE },
  { key: "cmsImages.help.hero", label: "Help — Hero image", pageGroup: "help", defaultUrl: HELP_HERO_IMAGE },
  { key: "cmsImages.careers.hero", label: "Careers — Hero image", pageGroup: "careers", defaultUrl: CAREERS_HERO_IMAGE },
