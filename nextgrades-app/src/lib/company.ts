...
/** Primary support inbox (marketing site, footer, contact). */
export const COMPANY_SUPPORT_EMAIL = "support@nextgrades.at";

export const COMPANY_MAILTO = `mailto:${COMPANY_SUPPORT_EMAIL}`;

export const COMPANY_WEBSITE = "https://www.nextgrades.at";
