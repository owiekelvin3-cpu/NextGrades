/**
 * Creates NextGrades test-mode products & recurring prices in Stripe.
...
async function main() {
  ...
  for (const plan of PLANS) {
    ...
    out[`STRIPE_PRICE_${envPrefix}_MONTHLY`] = monthly.id;
    out[`STRIPE_PRICE_${envPrefix}_YEARLY`] = yearly.id;
